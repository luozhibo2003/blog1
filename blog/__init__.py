...
from blog.extensions import bootstrap, db, moment, ckeditor, mail, migrate, login_manager, csrf
...
def register_blueprints(app):
    ...
    app.register_blueprint(auth_bp, url_prefiex='auth')
    app.register_blueprint(admin_bp, url_prefiex='admin')
...
# 使用工厂函数创建程序实例create_app(),
# 程序工厂（ApplicationFactory）：即生产程序的工厂，”，使用它可以在任何地方创建程序实例
